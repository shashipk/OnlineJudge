...
public class JavaCompiler {
	...
	private static Logger logger = Logger.getLogger(JavaCompiler.class);

	private String    data;
	private Integer   problemId;
	private JSONArray compilerOutput;
    ...
    private void createBatchFile(File file, String programFilePath, String input) throws IOException {
	    ...
	    String[] inputs = input.split("/n");
	    logger.info(inputs.length +""+ inputs);
